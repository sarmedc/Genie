...
public class ProductsUserAdapter extends RecyclerView.Adapter<ProductsUserAdapter.ProductViewHolder> {
    ...
    public ProductsUserAdapter(Context context, List<Product> productList) {
